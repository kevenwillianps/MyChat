...
try
{
    ...
    $usuarioValidate->setUsuarioId(@$_POST['cliente_id']);
    $usuarioValidate->setName(@$_POST['name']);
    ...
    else
    {
        ...
        if ($usuario->save($usuarioValidate->getUsuarioId(), $usuarioValidate->getName(), $usuarioValidate->getEmail(), $usuarioValidate->getPassword()))
        {
